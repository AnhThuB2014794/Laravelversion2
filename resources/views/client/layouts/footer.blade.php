        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">My</span>Shopper</h1>
            </a>

            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Bạc Liêu</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>nthu01867@gmail.com</p>
